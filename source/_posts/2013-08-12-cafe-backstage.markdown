...
{% img /images/cafe-backstage.jpg %}

{% ribbonp info 簡介%}
{% img right /images/cafe-backstage-3.jpg 150 %}
店名：後門咖啡（Cafe Backstage）
位置：台北市大安區復興南路 2 段 332 號
網址：<a href="https://www.facebook.com/CafeBackstage332">https://www.facebook.com/CafeBackstage332</a>
...
{% img left /images/cafe-backstage-2.jpg 300 %}
...
給筆者的第一印象就是「年輕」，除了因為後門咖啡約莫在 2013 5 月才開幕的，非常的年輕，又因為鄰近學校，在平日上班族需要上班的日子裡面，訪客很多是學生，除此也不時有教授光顧。

### 不定期的展演

{% img /images/cafe-backstage-8.jpg%}
...
{% img left /images/cafe-backstage-7.jpg 300 %}
### 食物
...
{% img /images/cafe-backstage-4.jpg %}
{% img /images/cafe-backstage-5.jpg %}
